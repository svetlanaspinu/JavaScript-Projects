...
//this modifies valiues each time a button is clicked on.
...
//this section handels the decimal points.
function Input_Decimal(dot) {
    //this ensure that accidental clicking of the decimal point doesn't cause bugs in the operation.
